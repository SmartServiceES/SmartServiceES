...
Scenario: Excluir prestador de servico
  Given Eu tenho um trabalhador com o nome "Joao Henrique", telefone "87123456789", data de nascimento "1990-01-01", email "joao@example.com", senha "123456" e profissao "Engenheiro"
