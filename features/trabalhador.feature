...
Scenario: Registrar prestador de servico   
    ...
    When Eu preencho nome "Joao Henrique", o telefone "87123456789", a data de nascimento "1990-01-01", o email "michizada@example.com", a senha "random122" e a profissao "Engenheiro"
...
Scenario: Editar prestador de servico
  Given O trabalhador com o nome "Joao Henrique", telefone "12345678998", data de nascimento "1990-01-01", email "beyblade2312@example.com", senha "oAmgcOaisN" e profissao "Engenheiro" existe
...
Scenario: Tentativa de cadastro com número de telefone muito curto
  ...
  When Eu preencho o nome "Joao Henrique", o telefone "123", a data de nascimento "1990-01-01", o email "azulcaneta@example.com", a senha "OpN11mICbh" e a profissao "Engenheiro"
  And Eu clico em Create Trabalhador
  Then Eu vejo a mensagem de erro "Telefone precisa ter 11 dígitos"

Scenario: Tentativa de edição com e-mail inválido
  Given Eu tenho no sistema um trabalhador com o nome "Joao Henrique", telefone "98765432132", data de nascimento "1990-01-01", email "canetaazul@example.com", senha "Qsx1fYtQyB" e profissao "Engenheiro"
