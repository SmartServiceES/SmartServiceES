Feature: Busca de cliente
  ...
  Scenario: Busca de cliente por nome Pedro Antonio
    ...
    And O cliente com nome completo "Pedro Antonio" data de nascimento "2000-09-14" cpf "97516259047" email "shouldz1@outlook.com" senha "ZECpmdzAKy" telefone "81998436108" rua "Rua Santos Dumount" numero "245" CEP "55715000" Bairro "Jardim santa rosa" cidade "Feira Nova" complemento "Casa" existe
