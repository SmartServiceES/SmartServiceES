...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference("Servico.count") do
      post servicos_url, params: { servico: { categoria: @servico.categoria, descricao: @servico.descricao, horario_inicio: @servico.horario_inicio, horario_termino: @servico.horario_termino, nome: @servico.nome, valor: @servico.valor } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { categoria: @servico.categoria, descricao: @servico.descricao, horario_inicio: @servico.horario_inicio, horario_termino: @servico.horario_termino, nome: @servico.nome, valor: @servico.valor } }
