...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, nome_da_rua: @endereco.nome_da_rua, numero_da_casa: @endereco.numero_da_casa } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, nome_da_rua: @endereco.nome_da_rua, numero_da_casa: @endereco.numero_da_casa } }
